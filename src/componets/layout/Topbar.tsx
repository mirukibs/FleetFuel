    ...
    <header className="sticky top-0 z-30 h-16 border-b border-border bg-background/80 backdrop-blur-xl flex items-center gap-3 px-4 lg:px-8">
      ...
      <div className="relative flex-1 max-w-md">
        ...
        <input
          ...
          className="w-full h-10 pl-10 pr-16 rounded-lg bg-muted/60 border border-transparent focus:bg-card focus:border-ring focus:ring-2 focus:ring-ring/20 outline-none text-sm transition"
        />
        <kbd className="hidden md:inline absolute right-3 top-1/2 -translate-y-1/2 text-[10px] font-mono text-muted-foreground border border-border rounded px-1.5 py-0.5">⌘K</kbd>
      </div>
      ...
      <div className="flex items-center gap-1.5 ml-auto">
        ...
        <Link to="/app/notifications" className="relative p-2.5 rounded-lg hover:bg-muted text-muted-foreground hover:text-foreground transition">
