...
export function KpiCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-border bg-card p-5 shadow-card hover:shadow-elevated transition-all">
      <div
        className={cn(
          "absolute -top-10 -right-10 size-32 rounded-full bg-gradient-to-br opacity-80",
          accents[accent]
        )}
      />
      ...
      <div className="relative flex items-start justify-between">
        <div>
          ...
          <div className="mt-2 font-display text-3xl font-semibold tracking-tight font-numeric">
            {value}
          </div>
      ...
      {delta !== undefined && (
        <div className="relative mt-4 flex items-center gap-1.5 text-xs font-medium font-numeric">
          <span
            className={cn(
