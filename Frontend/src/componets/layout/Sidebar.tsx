...
export function Sidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed lg:sticky top-0 z-50 h-screen w-64 shrink-0 bg-sidebar text-sidebar-foreground border-r border-sidebar-border flex flex-col transition-transform",
      ...
      >
        <div className="flex items-center justify-between px-5 h-16 border-b border-sidebar-border">
          ...
          <button className="lg:hidden text-sidebar-foreground/70" onClick={onClose}><X className="size-5" /></button>
        </div>
