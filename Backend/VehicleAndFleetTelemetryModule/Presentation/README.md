...
&emsp;	     1. Create fleet -  *[POST /api/fleets]*
&emsp;	     2. Update fleet name - *[PUT /api/fleets/{id}/name]*

**2. Telemetry controller**
- Exposes api endpoints according to the fleet use cases defined in the application layer:
&emsp;	     1. Register vehicle - *[POST /api/vehicles]*
&emsp;	     2. Update vehicle details - *[PUT /api/vehicles/{id}]*
&emsp;	     3. Assign vehicle to fleet - *[POST /api/vehicles/{id}/fleet]*
&emsp;	     4. Remove vehicle from fleet - *[Delete /api/vehicles/{id}]*
&emsp;	     5. Assign fuel sensor - *[POST /api/vehicles/{id}/fuel-sensor]*
...
&emsp;	     1. View fuel efficiency dashboard - *[GET /api/fleets/{fleetid}/dashboard]*
...
&emsp;	     1. Create manager - *[POST /api/managers]*