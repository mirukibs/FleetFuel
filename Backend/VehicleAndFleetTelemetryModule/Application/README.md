...
&emsp;	     1. Create fleet
&emsp;	     2. Update fleet name

**2. Fleet manager application service**
- Implements the following use case:
&emsp;	     1. Create fleet manager

**3. Vehicle application service**
- Implements the following use cases:
&emsp;	     1. Register vehicle
&emsp;	     2. Update vehicle details
&emsp;	     3. View vehicle details
&emsp;	     4. Assign vehicle to fleet
&emsp;	     5. Remove vehicle from fleet
&emsp;	     6. Assign fuel sensor

**4. Telemetry application service**
- Implements the following use cases:
&emsp;	     1. Generate simulated fuel reading
&emsp;	     2. Trigger fuel theft alert (as an extension of **generate simulated fuel reading** use case)
&emsp;	     3. View fuel efficiency dashboard
